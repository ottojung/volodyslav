...
/** @typedef {import('./index').Capabilities} Capabilities */
/** @typedef {import('./index').EventLogStorageCapabilities} EventLogStorageCapabilities */
...
/**
 * Factory function for creating an EventLogStorage instance.
 * @param {import('./index').EventLogStorageCapabilities} capabilities
