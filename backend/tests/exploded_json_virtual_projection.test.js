...
describe('exploded JSON virtual projection', () => {
    test('scalar emits paired schema and root rendered files', () => {
    ...
    test('object emits schema and sorted descendant leaves', () => {
    ...
    test('virtual sorting keeps each value projection together', () => {
        const keys = [
