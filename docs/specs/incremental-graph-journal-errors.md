...
- a stored Journal version has no complete canonical migration chain to the running version, or a proposed shortcut cannot reproduce the exact retained Journal defined by that chain.
