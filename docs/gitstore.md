...
| `generators/incremental_graph/database/gitstore.js` (`checkpointDatabase`) | `"generators-database"` | `"empty"` | Renders the live incremental-graph database into `rendered/` and snapshots it at migration boundaries |
